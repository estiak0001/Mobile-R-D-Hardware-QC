...
namespace WebAppEs.Migrations
{
    ...
    [Migration("20211013103416_updateFaultEntryAndDetailsTable2")]
    partial class updateFaultEntryAndDetailsTable2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebAppEs.Entity.MobileRNDFaultSubDetails", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("FaultDetailsID")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("FaultDetailsID");

                    b.HasIndex("SubCategoryID");

                    b.ToTable("MobileRNDFaultSubDetails");
                });
            ...
            modelBuilder.Entity("WebAppEs.Entity.MobileRNDFaultSubDetails", b =>
                {
                    b.HasOne("WebAppEs.Entity.MobileRNDFaultDetails", "MobileRNDFaultDetails")
                        .WithMany()
                        .HasForeignKey("FaultDetailsID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebAppEs.Entity.MRNDQC_SubCategory", "MRNDQC_SubCategory")
                        .WithMany()
